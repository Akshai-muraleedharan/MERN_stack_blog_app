...
const AuthLikeAndComment = ({addLike,likedBlog,userClick,unLike,addComment,checkComment}) => {
  ...
  return (
    ...
    <button onClick={addComment} disabled={checkUserAddComment} className="btn btn-neutral btn-sm">{checkUserAddComment ? "Comment Added" : "Add comment"}</button>   
</div> 
  )
}

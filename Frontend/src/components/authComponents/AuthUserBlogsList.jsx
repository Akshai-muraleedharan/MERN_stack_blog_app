    ...
    <div className="overflow-x-auto dark:bg-dark-cards-bg ">
              <table className="table ">
                <thead>
                  <tr>
                    ...
                    <th className='text-black dark:text-dark-smalls-text text-center'>Category</th>
      ...
      {postedBlog.map((item,index) => (
                  <tr key={item._id}>
                    ...
                    <td className='text-center text-black dark:text-dark-smalls-text'>{item.category}</td>

...
const Hero = () => {
  return (
            <div className="hero dark:bg-black bg-base-200 min-h-screen">
        <div className="hero-content text-center">
            <div className="max-w-md">
            <h1 className="text-4xl dark:text-white text-black font-bold">Expand Your Skills</h1>
            <p className="py-6 dark:text-white text-black">

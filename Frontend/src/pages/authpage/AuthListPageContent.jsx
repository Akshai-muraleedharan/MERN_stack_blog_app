...
const AuthListPageContent = () => {
  ...
  return (
    ...
    {loading ? <p className='flex justify-center mt-4'><span className="loading loading-spinner loading-md"></span></p> :  view ? <CreateBlogComponent view={view} fetchSinglePage={fetchSinglePage} setView={setView} fetchData={fetchData} sanitizedContent={sanitizedContent} /> : <div>
               ...
               <div>
                 ...
                 <div className='mt-12 md:mt-20 h-60 md:h-96  '>
                      ...
                      <div className='container mx-auto p-4 mb-10'>
                           <div className='mt-10 prose  w-full box-border' dangerouslySetInnerHTML={{__html:sanitizedContent}} ></div>
                      </div>
                 
                      <h3 className='font-semibold'>Comments</h3>
                    <div  className=' w-full mx-auto md:w-[80%]  flex flex-col  p-4 shadow-sm my-2  rounded-xl'> 
                              {comments.length === 0 ? <p className='text-center'>No Comment</p> : comments.map((item) => (

...
const AuthProfilePage = () => {
  ...
  return (
    <div className='px-5 md:px-10 lg:px-32  w-full mb-5 dark:bg-dark-bg bg-primary_bg' >
      ...
      <div className="mt-20 ">
        <h1 className='text-center mt-10 mb-5 font-semibold text-2xl dark:text-dark-heads text-primary-text'>Your Blogs</h1>

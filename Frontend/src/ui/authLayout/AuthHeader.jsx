    ...
    <div className="navbar dark:bg-dark-bg bg-primary_bg  shadow-sm px-5">
      ...
      <div className="flex gap-4 md:gap-10 md:flex-row-reverse items-center">
        ...
        <ul className='hidden md:flex gap-5'>
          <NavLink to={"/blog"}><li className={isActive('/blog') ? 'text-primary text-[14px] font-semibold in-dark:text-yellow-400' : 'text-[14px] dark:text-white text-primary-text font-semibold hover:text-gray-500 md:text-md cursor-pointer'}>Home</li></NavLink>
          <NavLink to={"create-blog"}><li className={isActive('/blog/create-blog') ? 'text-primary text-[14px] font-semibold in-dark:text-yellow-400' : 'text-[14px] dark:text-white text-primary-text font-semibold hover:text-gray-500 md:text-md cursor-pointer'}>Create Blog</li></NavLink>
          <NavLink to={"user-profile"}><li className={isActive('/blog/user-profile') ? 'text-primary text-[14px] font-semibold in-dark:text-yellow-400' : 'text-[14px] dark:text-white text-primary-text font-semibold hover:text-gray-500 md:text-md cursor-pointer'}>Profile</li></NavLink>
        </ul>
      </div>
    </div>

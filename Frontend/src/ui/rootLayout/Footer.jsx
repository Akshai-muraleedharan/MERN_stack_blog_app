...
const Footer = () => {
  return (
    <div className="mt-auto  border-t-1 dark:border-dark-footer-border  border-gray-200">
      <footer className="footer footer-horizontal dark:bg-dark-bg bg-primary_bg footer-center  text-base-content rounded p-10">
          ...
          <div className="grid grid-flow-col gap-4">
            ...
            <a>
              <svg
                ...
                height="24"
                viewBox="0 0 24 24"
                className="fill-current dark:text-dark-smalls-text cursor-pointer hover:text-red-400 dark:hover:text-red-400 text-black">
                <path
